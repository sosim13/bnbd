...
<link rel="stylesheet" type="text/css" href="${CssPath}/flexslider.css" />
...
<header class="navbar navbar-fixed-top" id="navbar_m">
    <div class="navbar-content">
    	<h1 >${HomePage}<a href="#" class="logo"></a></h1>
	...
	<section>
		...
		<h2 class="hide">메인배너</h2>
			<div id="container" class="cf">
			  ...
			  <!-- jQuery -->
			 <!-- <script>window.jQuery || document.write('<script src="${JsPath}/libs/jquery-1.7.min.js">\x3C/script>')</script> -->
